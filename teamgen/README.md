...
- **Flexible splitting** — by number of teams or by team size, with a live preview.
...
- **Share** — copy teams as text or download a CSV.
...
Next.js (App Router) · React · Tailwind CSS 4 · Firebase Auth + Firestore · SheetJS (`xlsx`) · Motion · Lucide icons
